...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Data pembayaran
    $biaya_pendaftaran = 30000; // Biaya pendaftaran untuk catur
            ...
            <form action="catur.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-4">
                    <div class="form-container event-info">
                        <img src="../layout/caturrrr.JPG" alt="Badminton" class="img-fluid">
                        <h5 class="mt-3">Catur</h5>
                        <p>
                        ...
                        <p>
                            Jenis Perlombaan: <span class="float-end">Catur</span><br>
                            Biaya Pendaftaran: <span class="float-end">Rp.30.000</span><br>
                            <hr>
                            <strong>Total: <span class="float-end">Rp.30.000</span></strong>
                        </p>
