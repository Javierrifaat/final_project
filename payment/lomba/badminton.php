...
<head>
    ...
    <title>RSC - PENDAFTARAN BADMINTON</title>
    <style>
        body {
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="form-container">
                    ...
                    <form action="badminton.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="nim1" class="form-label">Nomor Induk Mahasiswa 1:</label>
                                <input type="text" class="form-control" id="nim1" name="nim1" required>
                            </div>
                            <div class="col-md-6">
                                <label for="nim2" class="form-label">Nomor Induk Mahasiswa 2:</label>
                                <input type="text" class="form-control" id="nim2" name="nim2" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
            ...
            <div class="col-md-4">
                <div class="form-container event-info">
                    <img src="../layout/Badminton.JPG" alt="Bad minton" class="img-fluid">
                    ...
                    <p>
                        Jenis Perlombaan: <span class="float-end">Badminton</span><br>
                        Biaya Pendaftaran: <span class="float-end">Rp.100.00</span><br>
                        <hr>
                        <strong>Total: <span class="float-end">Rp.100.00</span></strong>
                    </p>
